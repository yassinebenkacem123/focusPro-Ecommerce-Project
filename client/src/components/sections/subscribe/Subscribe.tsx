...
const Subscribe = () => {
    return (
        <div className="flex py-10 px-7 mb-10 h-[70vh] justify-between bg-stone-200/40 gap-7 items-start">
            {/* left part. */}
            <div className="flex px-3 flex-col w-[65%] gap-10">
                <RevealText as="div">
                ...
                <div className="flex gap-3 items-center">
                    <div className="px-4 py-4 w-[60%] border border-gray-400/30 bg-white/80 rounded-full">
                        <input
                            ...
                            className="outline-none border-none text-xl text-stone-800 w-full bg-transparent"
                            type="text" />
                    </div>
